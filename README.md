...
*   [Design Concept: Parallel Universe](#design-concept-parallel-universe)
...
This project was developed as the capstone submission for the BA (Hons) Interior Architecture & Design program at the University of Hertfordshire. The module required the development and implementation of a major project demonstrating readiness for professional practice.

The core task was to select an existing building and introduce a new function, developing all programmatic, sustainable, aesthetic, and technical aspects. The final design needed to provide evidence of critical analysis, conceptual strength, and a deep understanding of the new intervention's impact on its users and environment. This involved constructing an in-depth project brief, engaging with functional and regulatory issues, and designing at a detailed level.
...
This project is supported by a comprehensive set of technical drawings, demonstrating a thorough understanding of building construction, regulations, and professional documentation standards. The included technical file details every aspect of the design, from the overall site plan down to individual construction details.

**The complete drawing set includes:**
*   Site & Location Plans
*   Demolition & Proposed Floor Plans (Ground & First Floor)
*   Exterior & Interior Elevations
*   Cross-Section Drawings (A-A & B-B)
*   Finishing, Furniture, and Reflected Ceiling Plans (RCP)
*   Detailed Construction and Feature Wall Designs
...
*   **Presentation & Portfolio Layout:** Adobe InDesign
*   **Conceptual Sketching & Annotation:** Procreate
